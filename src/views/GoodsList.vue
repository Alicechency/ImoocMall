        ...
        <div class="accessory-result">
          ...
          <div class="filter stopPop" id="filter" v-bind:class="{'filterby-show':filterBy}">
            <dl class="filter-price">
              <dt>Price:</dt>
              <dd>
                <a href="javascript:void(0)" v-bind:class="{'cur':priceChecked==4}" @click="getAllGoodsList">All</a>
              </dd>
...
export default {
  ...
  methods: {
    ...
    loadMore() {
      ...
      setTimeout(() => {
        this.page++;
        this.getGoodsList(true); //true为分页需要进行累加
      }, 1000);
    },
    addCart(productId) {
